...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`nama`,`email`,`password`) VALUES (nullif(?, 0),?,?,?)";
      }
  ...
  @Override
  public Object insertAll(final User[] users, final Continuation<? super Unit> $completion) {
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new User(_tmpId,_tmpNama,_tmpEmail,_tmpPassword);
            _result.add(_item);
          }
          return _result;
        } finally {
