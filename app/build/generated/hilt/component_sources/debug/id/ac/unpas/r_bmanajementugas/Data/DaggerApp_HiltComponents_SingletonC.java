...
import id.ac.unpas.r_bmanajementugas.viewmodel.TugasViewModel_HiltModules_KeyModule_ProvideFactory;
import id.ac.unpas.r_bmanajementugas.viewmodel.UserViewModel;
import id.ac.unpas.r_bmanajementugas.viewmodel.UserViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private KategoriTugasRepository kategoriTugasRepository() {
      return new KategoriTugasRepository(singletonCImpl.kategoriTugasDao());
    }

    private TugasRepository tugasRepository() {
      return new TugasRepository(singletonCImpl.tugasDao());
    }

    private UserRepository userRepository() {
      return new UserRepository(singletonCImpl.userDao());
    }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private KategoriTugasDao kategoriTugasDao() {
      return DatabaseModule_ProvideKategoriTugasDaoFactory.provideKategoriTugasDao(provideAppDatabaseProvider.get());
    }

    private TugasDao tugasDao() {
      return DatabaseModule_ProvideTugasDaoFactory.provideTugasDao(provideAppDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // id.ac.unpas.r_bmanajementugas.persistences.AppDatabase 
